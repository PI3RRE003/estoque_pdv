class ClientsController < ApplicationController
  ...
  private
    ...
    def client_params
      # O Rails 8 usa .expect para maior segurança.
      # Garanta que o :phone e o :neighborhood (bairro) estejam aqui.
      params.expect(client: [ :name, :cpf, :phone, :zipcode, :address, :neighborhood, :city, :state ])
    end
end
